...
//        return (T[]) Array.newInstance(type, size);
    ...
    public Integer[][] transpose(final Integer[][] matrix) {
        final Integer[][] result = new Integer[matrix[0].length][matrix.length];
    ...
    public Integer[][] sum(final Integer[][] matrixA, final Integer[][] matrixB) throws IllegalArgumentException {
        if (!sameOrderMatrix(matrixA, matrixB)) {
            throw new IllegalArgumentException("Matrix should have the same order.");
        }
        final Integer[][] result = new Integer[matrixA.length][matrixB.length];
    ...
    public boolean sameOrderMatrix(final Integer[][] matrixA, final Integer[][] matrixB) {
        ...
        return counterLineA == counterLineB && counterColumnA == counterColumnB;
    }
}
