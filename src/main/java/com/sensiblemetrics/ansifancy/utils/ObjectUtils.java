...
public class ObjectUtils {
     ...
     */
    public static boolean isCompatibleWithThrowsClause(Throwable ex, final Class<?>... declaredExceptions) {
     ...
     */
    final
    public static Object unwrapOptional(final Object obj) {
        if (obj instanceof Optional) {
     ...
     */
    public static boolean containsElement(final Object[] array, Object element) {
        if (array == null) {
            return false;
        }
