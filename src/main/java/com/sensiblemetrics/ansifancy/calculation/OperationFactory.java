package com.sensiblemetrics.ansifancy.calculation;
...
public class OperationFactory {
     ...
     */
    public static final Comparator<IntCoordinate> INT_COORDINATE_COMPARATOR = new MathComparator<>();

    /**
     * Default math operation declaration
     *
    ...
    public interface MathOperation<T> {
        ...
        int apply(@NonNull final T a, @NonNull final T b);
    }
