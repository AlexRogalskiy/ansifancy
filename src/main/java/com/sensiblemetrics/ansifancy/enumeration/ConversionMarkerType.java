 ...
 * <blockquote>
 *
 * <pre>{@literal @}Format({ConversionMarkerType.GENERAL, ConversionMarkerType.INT})
 ...
 * ({@link ConversionMarkerType#GENERAL}) and an integer as the second parameter ({@link
 * ConversionMarkerType#INT}).
 *
 * @checker_framework.manual #formatter-checker Format String Checker
 * @see Format
 */
public enum ConversionMarkerType {
    /**
    ...
    ConversionMarkerType(Class<? extends Object>[] types, String chars) {
        this.types = types;
        this.chars = chars;
    }
     ...
     *
     * <pre>
     * ConversionMarkerType.fromConversionChar('d') == ConversionMarkerType.INT;
     * </pre>
     *
     * </blockquote>
     */
    public static ConversionMarkerType fromConversionChar(char c) {
        for (ConversionMarkerType v : new ConversionMarkerType[]{GENERAL, CHAR, INT, FLOAT, TIME}) {
    ...
    public static boolean isSubsetOf(ConversionMarkerType a, ConversionMarkerType b) {
     ...
     *
     * <pre>
     * ConversionMarkerType.intersect(INT, TIME) == INT_AND_TIME;
     * </pre>
     *
     * </blockquote>
     */
    public static ConversionMarkerType intersect(ConversionMarkerType a, ConversionMarkerType b) {
        if (a == UNUSED) {
            return b;
        }
        if (b == UNUSED) {
        ...
        for (ConversionMarkerType v :
            new ConversionMarkerType[]{
     ...
     *
     * <pre>
     * ConversionMarkerType.union(INT, TIME) == GENERAL;
     * </pre>
     *
     * </blockquote>
     */
    public static ConversionMarkerType union(ConversionMarkerType a, ConversionMarkerType b) {
    ...
    /**
     * Returns a pretty printed {@link ConversionMarkerType}.
     */
    @Override
